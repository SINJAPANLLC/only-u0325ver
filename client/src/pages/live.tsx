...
function LiveStreamPage({
  ...
  return (
    <div 
      className="h-[calc(100svh-3.5rem)] w-full relative snap-start snap-always flex-shrink-0"
...
export default function Live() {
  ...
  return (
    <div 
      ref={containerRef}
      className="h-[calc(100svh-3.5rem)] overflow-y-scroll snap-y snap-mandatory scrollbar-hide"
